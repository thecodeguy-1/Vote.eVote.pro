...
const AppRoutes = [
  ...
  {
    path: '/apps/basic',
    component: lazy(() => import('../../views/apps/basic'))
  },
  {
    path: '/apps/ballot',
    component: lazy(() => import('../../views/apps/ballot'))
  },
  {
    path: '/apps/mydashboard',
    component: lazy(() => import('../../views/apps/mydashboard'))
  },
  {
    path: '/apps/voters',
    component: lazy(() => import('../../views/apps/voters'))
  },
  {
    path: '/apps/result',
    component: lazy(() => import('../../views/apps/result'))
  },
  {
    path: '/apps/start-stop',
    component: lazy(() => import('../../views/apps/start-stop'))
  },
  {
    path: '/apps/mysettings',
    component: lazy(() => import('../../views/apps/mysettings'))
  },
  {
    path: '/apps/faq',
    component: lazy(() => import('../../views/apps/faq'))
  },
  {
    path: '/apps/home',
